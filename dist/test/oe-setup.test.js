...
test('sshMirror rewrites https github URLs to ssh form', () => {
    assert.equal(sshMirror('https://github.com/D-Robotics/oe-skills-x5.git'), 'git@github.com:D-Robotics/oe-skills-x5.git');
    assert.equal(sshMirror('https://github.com/D-Robotics/oe-skills-x5'), 'git@github.com:D-Robotics/oe-skills-x5.git');
});
...
//# sourceMappingURL=oe-setup.test.js.map